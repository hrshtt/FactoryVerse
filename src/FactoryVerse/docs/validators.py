...
class StaticAttributeValidator:
    ...
    def _build_class_map(self) -> Dict[str, Type]:
        ...
        try:
            ...
            from FactoryVerse.factory.types import MapPosition, TilePosition
            from FactoryVerse.agent.placement_hints import (
                ConnectionPosition, WireConnectionPosition, GhostPlan, PolePlacementResult
            )
            from FactoryVerse.agent.embodied_actions.research import ResearchStatus, QueuedTechnology
