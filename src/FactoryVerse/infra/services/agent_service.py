...
from FactoryVerse.infra.session.file_manager import FileManager, SessionConfig, SessionPaths
...
class AgentService:
    ...
    async def continue_session(
        ...
        logger.info(f"Session {session_id} continued from trajectory, ready for turn {agent_session.turn_number}")
        return agent_session
