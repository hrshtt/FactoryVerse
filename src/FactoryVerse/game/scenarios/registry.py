...
Usage:
    >>> from FactoryVerse.game.scenarios.registry import get_scenario_adapter, detect_scenario
    >>>
...
from FactoryVerse.game.scenarios.base import ScenarioAdapter, RCONClientProtocol
