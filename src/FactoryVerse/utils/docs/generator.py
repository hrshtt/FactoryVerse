...
from FactoryVerse.utils.docs.registry import get_registry, DocumentationRegistry
...
class MarkdownGenerator:
    ...
    def _generate_preimported_types_section(self) -> str:
        ...
        try:
            from FactoryVerse.utils.docs.reference.inspection import generate_preimported_types_markdown
    ...
    def _generate_inspection_section(self) -> str:
        ...
        try:
            from FactoryVerse.utils.docs.reference.inspection import generate_inspection_markdown
