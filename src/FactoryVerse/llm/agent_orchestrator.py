...
class FactorioAgentOrchestrator:
        ...
        for iteration in range(1, 11):
            ...
            for tool_call in response.tool_calls:
                ...
                try:
                    ...
                    tool_results.append({"tool": tool_name, "result": result_preview})
    ...
    async def _check_notifications(self) -> list[Dict[str, Any]]:
        ...
        Note: With the new factory.py pattern, notifications are handled
        differently. This is a placeholder that returns empty for now.
        TODO: Implement notification checking with new runtime pattern.
        """
        # The new runtime pattern doesn't have get_notifications yet
        # Return empty for now - notifications are delivered via UDP listener
        return []
