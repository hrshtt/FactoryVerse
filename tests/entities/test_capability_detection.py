...
class TestBurnerCapabilityDetection:
    ...
    def test_burner_mining_drill_has_burner_mixin(self, rcon, test_ground, agent_id):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin
    ...
    def test_burner_inserter_has_burner_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin
        from FactoryVerse.game.factory.entity.implementations import BurnerInserter
        from FactoryVerse.game.factory.types import MapPosition, Direction
...
class TestElectricCapabilityDetection:
    ...
    def test_electric_mining_drill_has_electric_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.implementations import ElectricMiningDrill
        from FactoryVerse.game.factory.types import MapPosition, Direction
    ...
    def test_assembling_machine_has_electric_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import ElectricMixin
        from FactoryVerse.game.factory.entity.implementations import AssemblingMachine
        from FactoryVerse.game.factory.types import MapPosition
...
class TestMinerCapabilityDetection:
    ...
    def test_burner_mining_drill_has_miner_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import MinerMixin
        from FactoryVerse.game.factory.entity.implementations import BurnerMiningDrill
        from FactoryVerse.game.factory.types import MapPosition, Direction
...
class TestCrafterCapabilityDetection:
    ...
    def test_stone_furnace_has_crafter_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import CrafterMixin
        from FactoryVerse.game.factory.entity.implementations import StoneFurnace
        from FactoryVerse.game.factory.types import MapPosition
...
class TestInserterCapabilityDetection:
    ...
    def test_inserter_has_inserter_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import InserterMixin
        from FactoryVerse.game.factory.entity.implementations import Inserter
        from FactoryVerse.game.factory.types import MapPosition, Direction
    ...
    def test_fast_inserter_has_inserter_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import InserterMixin
        from FactoryVerse.game.factory.entity.implementations import FastInserter
        from FactoryVerse.game.factory.types import MapPosition, Direction
    ...
    def test_burner_inserter_has_both_burner_and_inserter_mixin(
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin, InserterMixin
        from FactoryVerse.game.factory.entity.implementations import BurnerInserter
        from FactoryVerse.game.factory.types import MapPosition, Direction
...
class TestBeltCapabilityDetection:
    ...
    def test_transport_belt_has_belt_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BeltMixin
        from FactoryVerse.game.factory.entity.implementations import TransportBelt
        from FactoryVerse.game.factory.types import MapPosition, Direction
...
class TestContainerDetection:
    ...
    def test_wooden_chest_is_container(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.implementations import WoodenChest, Container
        from FactoryVerse.game.factory.types import MapPosition
    ...
    def test_iron_chest_is_container(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.implementations import IronChest, Container
        from FactoryVerse.game.factory.types import MapPosition
...
class TestCompositeCapabilities:
    ...
    def test_burner_mining_drill_composite_capabilities(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin, MinerMixin
        from FactoryVerse.game.factory.entity.implementations import BurnerMiningDrill
        from FactoryVerse.game.factory.types import MapPosition, Direction
    ...
    def test_electric_mining_drill_composite_capabilities(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import ElectricMixin, MinerMixin
        from FactoryVerse.game.factory.entity.implementations import ElectricMiningDrill
        from FactoryVerse.game.factory.types import MapPosition, Direction
    ...
    def test_electric_furnace_composite_capabilities(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import ElectricMixin, CrafterMixin
        from FactoryVerse.game.factory.entity.implementations import ElectricFurnace
        from FactoryVerse.game.factory.types import MapPosition
    ...
    def test_stone_furnace_composite_capabilities(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin, CrafterMixin
        from FactoryVerse.game.factory.entity.implementations import StoneFurnace
        from FactoryVerse.game.factory.types import MapPosition
...
class TestCapabilityExclusion:
    ...
    def test_container_does_not_have_burner_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin
        from FactoryVerse.game.factory.entity.implementations import WoodenChest
        from FactoryVerse.game.factory.types import MapPosition
    ...
    def test_electric_entities_do_not_have_burner_mixin(self, rcon, test_ground):
        ...
        from FactoryVerse.game.factory.entity.capabilities import BurnerMixin
        from FactoryVerse.game.factory.entity.implementations import (
            ElectricMiningDrill,
            Inserter,
        )
        from FactoryVerse.game.factory.types import MapPosition, Direction
