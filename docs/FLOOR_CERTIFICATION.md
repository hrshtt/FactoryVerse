...
| L4.6 | `destroy_agents` destroys the agent character entity | create/destroy N agents; census characters | Zero leaked characters | live | 🔧 — observed 5 characters after 3 create/destroy cycles (or unique-force censusing artifact; settle by check) |
