...
walking:
  ...
  to(position: MapPosition, strict_goal: bool = ..., options: Union[dict, None] = ..., timeout: Union[int, None] = ...) -> None
    Walk to a position (async/await).

crafting:
  craft(recipe: RecipeName, count: int = ..., timeout: Union[int, None] = ...) -> ActionResult
  ...
  get_recipes(enabled_only: bool = ..., category: Union[RecipeCategory, None] = ...) -> list[Recipe]
...
reachable:
  ...
  get_resource(resource_name: ItemName, position: Union[MapPosition, None] = ...) -> Union[BaseResource, None]
    Get a single resource matching criteria.
  get_resources(resource_name: Union[ItemName, None] = ..., resource_type: Union[str, None] = ...) -> list[Union[ResourceOrePatch, BaseResource]]
    Get resources matching criteria.

map_db:
  connection: DuckDBConnection
    Get the DuckDB connection (automatically synced).
  ensure_synced(timeout: float = ...) -> ActionResult
  ...
  get_entity(query: str) -> Union[RemoteViewEntity, None]
    Get single read-only entity from DuckDB query.
  load_snapshots(snapshot_dir: Union[Path, None] = ..., db_path: Union[str, Path, None] = ..., kwargs: Any) -> None
...
ghosts:
  ...
  build_ghosts(ghosts: Union[list[str], None] = ..., area: Union[GhostAreaFilter, None] = ..., count: int = ..., strict: bool = ..., label: Union[str, None] = ...) -> ActionResult
...
ResourceOrePatch:
  ...
  mine(max_count: Optional[int] = ..., timeout: Optional[int] = ...) -> List['ItemStack']
...
HandCraftableRecipe:
  ...
  enabled: bool
  results: list[Result]
  craft(count: int = ..., timeout: Union[int, None] = ...) -> ActionResult
